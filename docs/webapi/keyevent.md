...
<p>デバイスでキーが押された際に通知を行うイベントを設定します。実際の通知はWebSocketを使いますので<a href="/websocket/keyevent.md">キーイベントAPI（WebSocket）</a>を参考にしてください。</p>
...
<p>デバイスでキーが押された<strong>後</strong>に通知を行うイベントを設定します。実際の通知はWebSocketを使いますので<a href="/websocket/keyevent.md">キーイベントAPI（WebSocket）</a>を参考にしてください。</p>
